...
class regForm : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegistrarFn.setOnClickListener {
            val nombreApellidoText:String = findViewById<TextView>(R.id.inputnombre).text.toString()
            val dniText:String = findViewById<TextView>(R.id.inputDni).text.toString()
            val emailText:String = findViewById<TextView>(R.id.inputEmail).text.toString()
